 ...
 * @author Lucas
 */
public class PortugueseComercialLetter extends ComercialLetter{
    
    public PortugueseComercialLetter(DataManager manager) {
        _dataManager = manager;
    }
    
    @Override
    public String header() {
        return _dataManager.getDate().getDay()+ "/" + _dataManager.getDate().getMonth()+ "/" + _dataManager.getDate().getYear()+ "\n\n"
                + "De: " + _dataManager.getSender().getName() + ", " + _dataManager.getSender().getAddress() + "\n"
    ...
    public String signature() {
        return "\n" + fitToRight("__________________") + "\n"
                ...
                + fitToRight("telefone: " +_dataManager.getSender().getPhone()) + "\n"
